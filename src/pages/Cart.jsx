...
function Cart() {
    ...
    const onClearCart = () => {
        if (window.confirm('Вы дейтсивтельно хотите очистить корзину?')){
            dispatch(clearCart());
        }
    };

    const onRemoveItem = (id) => {
        if(window.confirm('Вы дейтсивтельно хотите удалить?')) {
         ...
         <div className="container container--cart">
             {
                 ...
                 <div className="cart__bottom">
                     ...
                     <Button onClick={onClicklOrder}className= "pay-btn">
